...
async def run_test():
    ...
    try:
        ...
        # -> Enter invalid username/email and incorrect password in the login form.
        ...
        await page.wait_for_timeout(3000); await elem.fill('invalid@test.com')
        ...
        frame = context.pages[-1]
        # Click the 'Giriş Yap' (Login) button to submit the login form
        ...
        # -> Manually check the page visually for any error message or indication of login failure that might not be in the extracted content.
