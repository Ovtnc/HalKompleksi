...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Lightbox Navigation Enabled').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test case failed: The lightbox viewer did not open with full-screen display and swipe navigation upon tapping product images as required by the test plan.")
