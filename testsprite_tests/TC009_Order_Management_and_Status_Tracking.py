...
async def run_test():
    ...
    try:
        ...
        # -> Input email and password, then click login button to sign in as buyer.
        ...
        try:
            ...
            raise AssertionError("Test case failed: The order life cycle verification did not complete successfully as expected. The test plan requires verifying order creation, status updates, delivery info updates, and cancellation, but these steps did not pass.")
