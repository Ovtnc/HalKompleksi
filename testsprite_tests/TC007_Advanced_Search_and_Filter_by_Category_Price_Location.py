...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Search Results: No matching products found for the applied filters').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError('Test case failed: The product search and filtering did not return accurate and relevant results based on category, price range, and location filters as specified in the test plan.')
