...
async def run_test():
    ...
    try:
        ...
        # -> Input email and password, then click login button to proceed to upload page.
        ...
        try:
            ...
            raise AssertionError("Test case failed: The file upload system did not enforce type and size restrictions properly or did not handle uploads securely as expected.")
