...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Product Creation Successful!').first).to_be_visible(timeout=30000)
        except AssertionError:
            raise AssertionError("Test case failed: The product creation process did not complete successfully as per the test plan. Sellers were unable to create, read, update, or delete products with multiple images/videos, or location filtering did not work properly.")
