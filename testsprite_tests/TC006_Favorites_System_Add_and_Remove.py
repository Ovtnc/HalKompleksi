...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Product successfully added to favorites!').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test case failed: The test plan to verify adding and removing products from favorites failed because the expected confirmation message 'Product successfully added to favorites!' was not found on the page.")
